...
function test() {
    ...
    exec(resize_cmd, function (error, stdout, stderr) {
        ...
        var mosaic_cmd = 'gm "convert" "-page" "+0+0" "' + __dirname + '/user_image/tmp_bg.jpg" "-page" "+766+1501" "' + __dirname + '/user_image/small_15270569225682899.jpg" "-page" "+566+1501" "head_15270569225682899.jpg" "-mosaic" "' + __dirname + '/user_image/final.jpg"'
