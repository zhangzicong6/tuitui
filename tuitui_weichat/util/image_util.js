...
function user_img(ticket, qr_name, nickname, headimgurl, callback) {
    ...
    exec(resize_cmd, function (error, stdout, stderr) {
        exec(resize_head, function (errorhead, stdouthead, stderrhead) {
            ...
            var mosaic_cmd = 'gm "convert" "-page" "+0+0" "' + __dirname + '/user_image/tmp_bg.jpg" "-page" "+766+1501" "' + __dirname + '/user_image/small_' + qr_name + '" "-page" "+356+1501" "' + __dirname + '/user_image/smallhead_' + qr_name + '" "-mosaic" "' + __dirname + '/user_image/' + qr_name + '"'
